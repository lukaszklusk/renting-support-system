...
import { Nav, Container, Row, Col, Card, Form, Button, Alert, InputGroup } from 'react-bootstrap';
              ...
              <Form.Group controlId="formUsername" className='my-3'>
                ...
                <Form.Group controlId="formUsername" className='my-3'>
                  <InputGroup>
                    ...
                    />
                    <Form.Control.Feedback type="invalid" className='ms-5'>
                      Please enter a username with following restrictions:<br />
                      - between 4 and 24 characters <br />
                      - begin with a letter <br />
                      - only numbers, letters, underscores and hyphens allowed
                    </Form.Control.Feedback>
                  </InputGroup>
                </Form.Group>
                ...
                <Form.Group controlId="formPassword" className='my-3'>
                  <InputGroup>
                    ...
                    />
                    <Form.Control.Feedback type="invalid" className='ms-5'>
                      Please enter a password with following restrictions:<br/>
                      - between 8 and 24 characters <br />
                ...
                <Form.Group controlId="termsCheckbox" className='my-3 d-flex justify-content-end'>
                  <Form.Check
                    type="checkbox"
                ...
                <div className="d-flex justify-content-end">
                  <Button 
                    variant="primary" 
                    type="submit" 
                    disabled={isEmailValid && isUsernameValid && isPasswordValid && isRepeatPasswordValid && isAgreeTerms ? false : true}>
                    Sign Up
                  </Button>
                </div>
              </Form>
